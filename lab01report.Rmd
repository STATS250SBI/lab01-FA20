...
3. **Asynchronous remote:** Join a Piazza lab group for asynchronous collaboration. **TODO: FIGURE THIS OUT, PROVIDE DIRECT LINKS**
...
1. At the top of the document, make sure you've changed the `author` field to your name (in quotes!). If you'd like, change the date as well.
2. **TODO: Screenshots!**
3. Give yourself a high five - you just wrote code! *Under no circumstances should you give another person a high five; it's a pandemic*
